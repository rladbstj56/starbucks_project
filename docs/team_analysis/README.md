...
이 폴더는 실제 노트북을 이동하지 않고, 팀원별 분석 산출물을 문서상으로 구분하기 위한 공간입니다.
...
포트폴리오나 면접에서는 팀 전체 산출물과 본인 개인 기여를 분리해서 설명해야 합니다.

- 팀 전체 산출물: 최종 제출 노트북, 최종 데이터셋, 발표 자료
- 본인 기여: 오퍼별 인지율/전환율, 채널별/채널수별 분석 전체, 소셜/모바일 채널 해석, 프로젝트 종료 후 채널 분석 고도화
- 본인 기여 제외: 고객 세그먼트 분석, 오즈비(오드비) 검정, 오퍼타입별 분석
- 사용자 확인 필요: `analysis_offer_df.csv`
